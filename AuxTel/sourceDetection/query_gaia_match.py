...
collection = 'u/tickets/SITCOM-306_piff'
rapid_butler = False
...
if rapid_butler:
    ...
    butler = dafButler.Butler('/sdf/group/rubin/' + repo, collections=[collection])
    registry=butler.registry
...
# running the code
Parallel(n_jobs=nCores)(delayed(doTask)(expId) for expId in expIds)
