...
nCores = 12
outname = 'data/flat_field_pairs_comCam_may2022_{}.csv'
...
butler = dafButler.Butler("/repo/main", collections=["LSSTComCam/raw/all","LSSTComCam/calib"])
...
refs = sorted(registry.queryDatasets('raw', collections=["LSSTComCam/raw/all","LSSTComCam/calib"], instrument='LSSTComCam'))
...
# with exposure time lower than 360 sec
exp_time_th = exp_time[1:]<360.
